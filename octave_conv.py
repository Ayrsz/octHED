...
class Conv_BN(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, alpha_in = 0.5, alpha_out = 0.5, stride = 1, padding = 0, dilation = 1,
                groups = 1, bias = True, norm_layer = nn.BatchNorm2d):
        print("CONV_BN")
...
class OctaveConv_ACT(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, alpha_in = 0.5, alpha_out = 0.5, stride = 1, padding = 0, dilation = 1,
                groups=1, bias = True, activation_layer = nn.ReLU):
...
class Conv_BN_ACT(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, alpha_in = 0.5, alpha_out = 0.5, stride = 1, padding = 0, dilation = 1,
                groups=1, bias = True, norm_layer = nn.BatchNorm2d, activation_layer = nn.ReLU):
